...
'input name more than 70 char'
WebUI.callTestCase(findTestCase('Test Cases/pages/register new user account'), [('email'):email, ('name'):name], FailureHandling.STOP_ON_FAILURE)
