...
WebUI.callTestCase(findTestCase('Test Cases/pages/register new user account'), [('email'): email, ('name'):name, ('isRegister'):isRegister], FailureHandling.STOP_ON_FAILURE)
