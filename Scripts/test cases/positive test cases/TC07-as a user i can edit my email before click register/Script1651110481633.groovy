...
WebUI.callTestCase(findTestCase('Test Cases/pages/register new user account'), [('email'): email, ('isEdit'):isEdit, ('newEmail'): newEmail, ('name'):name, ('isRegister'):isRegister], FailureHandling.STOP_ON_FAILURE)

'verify user redirected to otp page right after click register'
